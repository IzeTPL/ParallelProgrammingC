...
#pragma omp task final( level>max_level ) default(none) shared(a_max_1) firstprivate(A,p,r,s,level) 
        {
            if (omp_in_final()){
...
#pragma omp task final( level>max_level ) default(none) shared(a_max_2) firstprivate(A,p,r,s,level) 
        {
            if (omp_in_final()){
